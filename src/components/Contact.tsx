    ...
    <section id="contact" className="py-32 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            <div className="relative backdrop-blur-2xl bg-gradient-to-br from-white/[0.12] to-white/[0.04] border border-[#6EAEDC]/20 rounded-3xl p-8 shadow-2xl shadow-[#6EAEDC]/5">
